create table EMP_EMP	(
				dniSupervisado			char(9),
				dniSupervisor 			char(9),
				CONSTRAINT CP_EMP_EMP	PRIMARY KEY (dniSupervisado),
				CONSTRAINT Ca_EMP_EMP	FOREIGN KEY (dniSupervisado) REFERENCES EMPLE (dni),
				CONSTRAINT Ca_EMP_EMP2	FOREIGN KEY (dniSupervisor) REFERENCES EMPLE (dni)
				ON DELETE CASCADE
			)
/
