create table EMP_INV_PRO	(
					dni		char(9),
					nom_pro	varchar2(50),
					CONSTRAINT Cp_EMP_INV_PRO PRIMARY KEY (dni,nom_pro),
					CONSTRAINT CF_EMP_INV_PRO_EMPLE FOREIGN KEY (dni) REFERENCES EMPLE(dni),
					CONSTRAINT CF_EMP_INV_PRO_PROYECTO FOREIGN KEY (nom_pro) REFERENCES PROYECTO(nom_pro)
					ON DELETE CASCADE		
				)
/
